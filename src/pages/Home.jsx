...
import { Send, AlertCircle, Loader2, User, Mail, MessageSquare, Briefcase, Heart, Headset } from 'lucide-react';
    ...
    <div className="app-container">
      ...
      >
        <div style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', maxHeight: '300px', overflowY: 'auto', paddingRight: '0.5rem' }}>
          <p style={{ marginBottom: '1rem' }}><strong>1. Aceptación de los términos</strong><br/>Al utilizar este formulario de contacto, aceptas que tus datos sean procesados con el fin de resolver tu consulta.</p>
          <p style={{ marginBottom: '1rem' }}><strong>2. Uso de la información</strong><br/>Tus datos no serán compartidos con terceros sin tu consentimiento expreso.</p>
          <p><strong>3. Derechos del usuario</strong><br/>Puedes solicitar la eliminación de tus datos respondiendo a nuestros correos.</p>
        </div>
        <button 
          className="submit-btn" 
